...
const Details = ({ type, time, place, info }) => {
  ...
  return (
    <li
      ref={ref}
      className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between  dark:text-light md:w-[80%]"
    >
      ...
      >
        ...
        <spn className="capitalize font-medium text-dark/75 dark:text-light/75 xs:text-sm">
          {time} | {place}
        </spn>
...
const Education = () => {
  ...
  return (
    <div className="my-64 lg:my-56 md:my-32">
